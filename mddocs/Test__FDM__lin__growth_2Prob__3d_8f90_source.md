...
[**File List**](files.md) **>** [**Exec**](dir_43a12cefb7942b6f49b5b628aafd3192.md) **>** [**Test\_FDM\_lin\_growth**](dir_97d68d96f71fb742273f5b8113c9a269.md) **>** [**Prob\_3d.f90**](Test__FDM__lin__growth_2Prob__3d_8f90.md)

[Go to the documentation of this file.](Test__FDM__lin__growth_2Prob__3d_8f90.md) 
...
!just the axion star.
      ...
      double precision x, y, z, xtilde, ytilde, ztilde, del
      ...
      do k = lo(3), hi(3)
         do j = lo(2), hi(2)
            do i = lo(1), hi(1)
               ...
               xtilde = 2.0d0*m_pi*x/ (domhi(1)-domlo(1)) / delta(1)
               ytilde = 2.0d0*m_pi*y/ (domhi(2)-domlo(2)) / delta(2)
               ztilde = 2.0d0*m_pi*z/ (domhi(3)-domlo(3)) / delta(3)

               del = 0.01
               axion(i,j,k,uaxdens) = (1.d0-del*cos(xtilde))*meandens
               
               ! NO INITIAL VELOCITY
               axion(i,j,k,uaxre)   = dsqrt(axion(i,j,k,uaxdens))
               axion(i,j,k,uaxim) = 0.0
