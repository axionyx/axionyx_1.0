...
[Go to the documentation of this file.](Source_2Nyx_8H.md) 
...
public:
    ...
    //
    //
    void particle_redistribute(int lbase = 0, int iteration = 0, bool init = false);
    ...
    void advance_FDM_PS(amrex::Real time, amrex::Real dt, amrex::Real a_old, amrex::Real a_new);
#endif
  ...
  int integrate_state_grownexact(amrex::MultiFab &state,   amrex::MultiFab &diag_eos, const amrex::Real& a, const amrex::Real& delta_time);
   ...
   int integrate_state_grownvec(amrex::MultiFab &state,   amrex::MultiFab &diag_eos, const amrex::Real& a, const amrex::Real& delta_time);
    ...
    //
    //
    virtual void post_regrid(int lbase, int iteration, int new_finest);
...
#ifdef FDM
    static FDMParticleContainer* theFDMPC();
    static FDMParticleContainer* theVirtFDMPC();
    static FDMParticleContainer* theGhostFDMPC();
    static FDMwkbParticleContainer* theFDMwkbPC();
    static FDMwkbParticleContainer* theVirtFDMwkbPC();
    static FDMwkbParticleContainer* theGhostFDMwkbPC();
#endif
    ...
    static amrex::Real meandens;
    static int FDlevel;
    static int GBlevel;
    static int NBlevel;
    static int PSlevel;
    static bool partlevel;
    static amrex::Vector<int> levelmethod;
...
#ifdef FDM
    static long num_particle_fdm;                                                                                                                                                                      
    static long num_particle_dm;                                                                                                                                                                    
#endif
